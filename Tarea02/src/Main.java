...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Memoria total: " + memoriaTotal/1024 + " Mib");

        long memoriaLibre = rt.freeMemory();
        System.out.println("Memoria libre: " + memoriaLibre/1024+ " Mib");

        // Memoria en uso
        System.out.println("Memoria en uso: " + (memoriaTotal - memoriaLibre) / 1024 + "MiB");
